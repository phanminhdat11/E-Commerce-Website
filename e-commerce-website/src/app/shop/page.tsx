...
import { fetchProduct, Product } from "@/lib/redux/products/productSice";
...
export default function ShopPage() {
    ...
    const {listDataProduct}  = useAppSelector(
            ...
            <div className="relative left-1/2 w-[calc(100vw-2rem)] max-w-[1720px] -translate-x-1/2 space-y-6 pb-20 md:w-[calc(100vw-8rem)] md:pb-6 lg:w-[calc(100vw-21rem)] 2xl:w-[calc(100vw-23rem)]">
                <div className="flex flex-col gap-4 border-b border-slate-200 pb-4 xl:flex-row xl:items-center xl:justify-between">
                    ...
                    <div className="flex flex-col gap-3 sm:flex-row sm:items-center xl:min-w-[28rem] xl:justify-end">
                        <div className="sm:flex-1 xl:max-w-md">
                            <SearchBoxComponent />
                        </div>
                        <ButtonComponent
                            type="button"
                            ...
                            variant="outline"
                            iconStart={<FontAwesomeIcon icon={openFilter ? faXmark : faFilter} className="text-base" />}
                            label={openFilter ? "Dong bo loc" : "Bo loc"}
                ...
                <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 xl:gap-5 2xl:grid-cols-5 2xl:gap-6">
                    {/* <ItemCardComponent product={data} /> */}

                    {
                        listDataProduct.map((product: Product)=> (
